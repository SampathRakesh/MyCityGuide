...
public class atmframe extends JFrame {
	...
	public atmframe() {
		...
		lblNewLabel.setBounds(169, 102, 148, 40);
		contentPane.add(lblNewLabel);
		
		JComboBox comboBox = new JComboBox();
		comboBox.setFont(new Font("Andalus", Font.PLAIN, 12));
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"China-amiram", "JpRoad", "Gunupudi", "SundayMarket"}));
		comboBox.setBounds(372, 109, 182, 30);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
		 			...
		 			String ur="select * from atm where address='"+data+"'";
		...
		btnNewButton.setBounds(465, 160, 89, 23);
		contentPane.add(btnNewButton);
		
		table = new JTable();
		table.setBackground(new Color(211, 211, 211));
		table.setBounds(41, 248, 474, 272);
		contentPane.add(table);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon("F:\\chrome downloads\\bank-card-money-hand-wallpaper-preview.jpg"));
		lblNewLabel_1.setBounds(10, 11, 875, 529);
