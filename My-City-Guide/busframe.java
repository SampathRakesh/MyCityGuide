...
public class busframe extends JFrame {
	...
	public busframe() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Vijayawada", "Gudivada", "Narasapuram", "Palakollu", "Tadepalligudem", "Tanuku", "Ganapavaram", "Eluru", "Rajahmundry", "Vizag", "Hyderabad", "Kakinada"}));
		comboBox.setBounds(41, 98, 164, 22);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
		 			...
		 			String ur="select * from buses where Destination='"+data+"'";
		...
		btnNewButton.setBounds(116, 131, 89, 23);
		contentPane.add(btnNewButton);
		
		table = new JTable();
		table.setForeground(SystemColor.text);
		table.setBackground(SystemColor.windowText);
		table.setBounds(28, 218, 388, 261);
		contentPane.add(table);
		
		JLabel lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon("F:\\chrome downloads\\marc-jackson-final.jpg"));
